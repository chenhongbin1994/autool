...
#define CMT_CSB_GPIO_PIN            GPIO_Pin_5

#define CMT_FCSB_GPIO               GPIOA
#define CMT_FCSB_GPIO_PIN           GPIO_Pin_4

#define CMT_SCLK_GPIO               GPIOA
#define CMT_SCLK_GPIO_PIN           GPIO_Pin_7

#define CMT_SDIO_GPIO               GPIOA
#define CMT_SDIO_GPIO_PIN           GPIO_Pin_6

#define CMT_GPIO1_GPIO              GPIOB
#define CMT_GPIO1_GPIO_PIN          GPIO_Pin_15

#define CMT_GPIO2_GPIO              GPIOB
#define CMT_GPIO2_GPIO_PIN          GPIO_Pin_14

#define CMT_GPIO3_GPIO              GPIOB
#define CMT_GPIO3_GPIO_PIN          GPIO_Pin_13

#define CMT_GPIO4_GPIO              GPIOB
#define CMT_GPIO4_GPIO_PIN          GPIO_Pin_12
